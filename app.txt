...
# Password dùng chung cho tài khoản mail.tm và vsphone
PASSWORD = "quynhduy23"
...
def login(email_alias, code):
    payload = {
        ...
        "loginType": 0,
        "verifyCode": code,
        "password": "526a97afaa842892fa91dcc5f9a23d91", # MD5 của password hoặc hash hệ thống
        "channel": "vsagq956gu"
    }
    headers = {
        "accept": "*/*",
...
def create_account():
    ...
    try:
        ...
        # CẬP NHẬT: Trả về Email (alias) và Password
        return jsonify({
            "email": alias,
            "password": PASSWORD,
            "userId": uid,
...
if __name__ == "__main__":
    app.run(debug=True, port=5001) # Chạy port 5001 tránh trùng với Node.js
